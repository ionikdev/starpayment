...
import { styles } from "../../styles/electricity";

const datas = [
  {
    name: "Ikeja Electricity",
    icon: require("../../assets/icons/ikejaelec.png"),
  },
  {
    name: "Ibadan Electricity",
    icon: require("../../assets/icons/ibadanelec.png"),
  },
  {
    name: "Abuja Electricity",
    icon: require("../../assets/icons/abujaelec.png"),
  },
  { name: "Jos Electricity", icon: require("../../assets/icons/joselec.png") },
  {
    name: "Kaduna Electricity",
    icon: require("../../assets/icons/kadunaelec.png"),
  },
];
const plans = [
  { id: 1, period: "Prepaid", icon: require("../../assets/icons/flash.png") },
  {
    id: 2,
    period: "Postpaid",
  ...
  return (
    <BottomSheetModalProvider>
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalDetailRow}>
                <Text style={styles.modalDetailLabel}>Meter number:</Text>
        ...
        >
          <Text style={styles.bottomSheetHeading}>ACCOUNT TYPE</Text>
