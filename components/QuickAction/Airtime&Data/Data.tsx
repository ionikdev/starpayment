...
const plans = [
  { id: 1, period: "1 YEAR", amount: "NGN100,00" },
  { id: 2, period: "DAILY DATA PLAN", amount: "890,00" },
  { id: 3, period: "WEEKLY DATA PLAN", amount: "100,00" },
  { id: 4, period: "2WEEK DATA PLAN", amount: "650,00" },
  { id: 5, period: "24 DAYS DATA PLAN", amount: "800,00" },
  { id: 6, period: "19 DAYS DATA PLAN", amount: "650,00" },
  { id: 7, period: "NIGHT DATA PLAN", amount: "800,00" },
  { id: 8, period: "30 HOURS DATA PLAN", amount: "650,00" },
  { id: 9, period: "EVENING DATA PLAN", amount: "800,00" },
  { id: 10, period: "56 DAY DATA PLAN", amount: "650,00" },
  { id: 11, period: "AFTERNOON DATA PLAN", amount: "800,00" },
  { id: 12, period: "4 MONTH DATA PLAN", amount: "650,00" },
  { id: 13, period: "NIGHTY DATA PLAN", amount: "800,00" },
  { id: 14, period: "MONTHLY DATA PLAN", amount: "650,00" },
  { id: 15, period: "OK DATA PLAN", amount: "800,00" },
];
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.buyButtonContainer}>
          <TouchableOpacity style={styles.buyButton} onPress={handleBuydata}>
            <Text style={styles.buyButtonText}>Buy ₦{selectedAmount} data</Text>
          </TouchableOpacity>
        </View>
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalDetailRow}>
                ...
                <Text style={styles.modalDetailValue}>{selectedData}</Text>
              </View>
              <View style={styles.modalDetailRow}>
              ...
              <View style={styles.modalDetailRow}>
                <Text style={styles.modalDetailLabel}>Data plan:</Text>
          ...
          <View style={styles.modalContainerPin}>
            <View style={styles.modalContentPin}>
              ...
              <Text style={styles.modalSubText}>
                ...
                {selectedData} data on {mobileNumber} now.
              </Text>
